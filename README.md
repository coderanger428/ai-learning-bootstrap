...
| P08 | **Simple Image Classifier** – Classify images (e.g., dogs vs cats) using a CNN in PyTorch; implement dataset loading, augmentation, training, evaluation, and prediction visualization                                                                     |      | in progress |
