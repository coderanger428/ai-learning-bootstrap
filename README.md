...
| P06 | **MNIST CNN (PyTorch)** – Classify handwritten digits using a Convolutional Neural Network; implement convolution layers, pooling, feature extraction, training, evaluation, and performance visualization                                                 |      | in progress |
