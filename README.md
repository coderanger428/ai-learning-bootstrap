...
| P11 | **Face Recognition System** – Build a face recognition pipeline using embedding models; implement face detection, embedding extraction, similarity matching, identity prediction, and real-time webcam recognition                                         |      | in progress |
