...
| P05 | **MNIST Classifier (PyTorch MLP)** – Reimplement MNIST digit classification using PyTorch; focus on tensor operations, automatic differentiation, model definition, training loop, and evaluation pipeline                                                 |      | in progress |
