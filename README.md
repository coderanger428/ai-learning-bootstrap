...
| P04 | **MNIST Classifier (NumPy)** – Classify handwritten digits (0–9) using a fully connected MLP implemented purely in NumPy; include data normalization, batching, training loop, evaluation, and accuracy/loss visualization                                 |      | in progress |
