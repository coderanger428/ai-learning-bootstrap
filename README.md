...
| P07 | **Tabular ML Benchmark Project** – Train and compare Linear Regression, Random Forest, and MLP models on the same structured dataset; analyze performance, generalization, and model suitability for tabular data                                          |      | in progress |
