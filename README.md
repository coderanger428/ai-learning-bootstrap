...
| P10 | **Object Counter System** – Count objects in images/video using detection + tracking; combine a detector with object tracking to produce real-time counting and annotated video output                                                                     | https://github.com/coderanger428/ai-object-counter | complete |
| P11 | **Face Recognition System** – Build a face recognition pipeline using prebuilt models. Recognize age and gender of faces from a video stream in real time                                         | https://github.com/coderanger428/ai-face-recog | complete |
| P12 | **OCR Pipeline** – Extract text from printed document images using preprocessing, segmentation, detection, and recognition stages; visualize detected text regions and reconstructed text output                                                           | https://github.com/coderanger428/ai-ocr-pipeline | complete |
| P13 | **Tokenizer Project** – Implement word-level and subword-level tokenizers for text corpora; handle vocabulary construction, encoding/decoding, and token frequency analysis                                                                                | https://github.com/coderanger428/ai-tokenizer | complete |
| P14 | **Text Vectorization System** – Convert text into numerical representations using Bag-of-Words, TF-IDF, and embedding-based representations; visualize feature spaces and similarity structures                                                            | https://github.com/coderanger428/ai-text-vectorization | complete |
| P15 | **Text Classifier** – Build a sentiment/intent classifier using vectorized text representations; implement preprocessing, training, evaluation, and classification visualization                                                                           |      | in progress |
