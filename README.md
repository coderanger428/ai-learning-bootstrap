...
| P12 | **OCR Pipeline** – Extract text from printed document images using preprocessing, segmentation, detection, and recognition stages; visualize detected text regions and reconstructed text output                                                           |      | in progress |
